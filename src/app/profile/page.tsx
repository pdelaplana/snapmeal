...
export default function ProfilePage() {
  ...
  const averageDailyCaloriesLast7Days = useMemo(() => {
    ...
    const recentMeals = meals.filter(
      (meal) => new Date(meal.timestamp) >= sevenDaysAgo,
    );

    if (recentMeals.length === 0) return 0;

    const calorieSum = recentMeals.reduce(
        ...
        <div className="space-y-8">
            ...
            <Card className="shadow-md">
              ...
              <CardContent>
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  Note: Labels in the photo capture tool might refer to "meal
                  photo". This tool is reused for profile picture functionality.
                </p>
                <Button
          ...
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>
                A quick look at your meal logging activity.
              </CardDescription>
            </CardHeader>
