...
export default function EditMealPage() {
  ...
  const [aiEstimation, setAiEstimation] =
  ...
  useEffect(() => {
    ...
    if (mealToEdit) {
      ...
      if (
        ...
        (mealToEdit.protein != null ||
          mealToEdit.carbs != null ||
          mealToEdit.fat != null)
      ) {
  ...
  useEffect(() => {
    ...
    if (aiEstimation && aiEstimation.isMealDetected) {
      ...
      if (
        ...
        setManualProtein(
          aiEstimation.macroBreakdown?.protein?.toFixed(1) ?? "",
        );
    ...
    try {
      ...
      if (!result.isMealDetected) {
        ...
        toast({
          ...
          description:
            "Nutritional values have been re-estimated. Review and save.",
        });
      }
    } catch (error: any) {
      ...
      toast({
        ...
        description:
          error.message || "Could not re-estimate nutrition. Please try again.",
      });
      ...
      <AppLayout>
        <div className="container mx-auto max-w-3xl px-4 py-8 text-center">
          <p className="text-lg text-destructive">
            Meal not found or an error occurred.
          </p>
          <Button
        ...
        <div className="space-y-10">
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <Alert variant="default" className="mt-3">
                    ...
                    <AlertDescription>
                      If you change the photo or want a new nutrition estimate,
                      provide relevant details here and click "Re-estimate
                      Nutrition".
                    </AlertDescription>
                  </Alert>
                </div>
          ...
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>
                Verify or update the nutritional information and other details
                for your meal log.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-2 py-2">
                ...
                />
                <Label
                  htmlFor="toggle-manual-inputs-edit"
              ...
              {showManualInputs && (
                <>
                  {(selectedEstimationType === "calories_macros" ||
                    selectedEstimationType === "calories_only") && (
                    <div>
                      <Label htmlFor="manualCaloriesEdit">
                  ...
                  {(selectedEstimationType === "calories_macros" ||
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      <div>
                        <Label htmlFor="manualProteinEdit">
                          Logged Protein (g)
                        </Label>
                        <Input
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        delete this meal from your log.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
