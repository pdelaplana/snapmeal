...
export default function EditMealPage() {
  ...
  useEffect(() => {
    ...
    if (mealToEdit) {
      ...
      if (
        mealToEdit.estimatedCalories != null &&
        (mealToEdit.protein != null || mealToEdit.carbs != null || mealToEdit.fat != null)
      ) {
  ...
  const handleEstimate = async () => {
    if (!photoDataUri) {
      toast({
        variant: 'destructive',
        title: 'No Photo',
        description: 'Please ensure a photo is present to estimate nutrition.',
      });
      return;
    }
    ...
    try {
      ...
      if (!result.isMealDetected) {
        ...
        toast({
          title: 'New Estimation Complete',
          description: 'Nutritional values have been re-estimated. Review and save.',
        });
      }
    } catch (error: any) {
      ...
      toast({
        variant: 'destructive',
        title: 'Re-estimation Failed',
        description: error.message || 'Could not re-estimate nutrition. Please try again.',
      });
      ...
      setAiEstimation(
        initialMealData
          ? {
              ...
              macroBreakdown:
                initialMealData.protein != null ||
                initialMealData.carbs != null ||
                initialMealData.fat != null
                  ? {
  ...
  const canUpdateMeal = () => {
    if (!initialMealData || !photoDataUri || !selectedMealType || !selectedDate || !selectedTime)
      return false;
  ...
  const handleUpdateMeal = () => {
    if (!initialMealData || !canUpdateMeal()) {
      toast({
        variant: 'destructive',
        title: 'Cannot Update Meal',
        description:
          'Please ensure all required fields are filled and all required nutritional fields for the selected estimation type are valid numbers.',
      });
      return;
    }
    ...
    <AppLayout>
      <div className='container mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8'>
        <div className='space-y-10'>
          ...
          <MealCapture onPhotoCaptured={handlePhotoCaptured} initialPhotoDataUri={photoDataUri} />
              ...
              <CardContent className='space-y-6'>
                <div>
                  ...
                  <Alert variant='default' className='mt-3'>
                    ...
                    <AlertDescription>
                      If you change the photo or want a new nutrition estimate, provide relevant
                      details here and click "Re-estimate Nutrition".
                    </AlertDescription>
                  </Alert>
                </div>

                <div>
                  <Label htmlFor='estimationTypeEdit' className='text-md font-medium'>
                    Estimation Type
                  </Label>
                  <Select
          ...
          <Card className='shadow-md'>
            ...
            <CardContent className='space-y-6'>
              ...
              <div className='flex items-center space-x-2 py-2'>
                ...
                />
                <Label htmlFor='toggle-manual-inputs-edit' className='text-md cursor-pointer'>
              ...
              <div className='flex flex-col gap-4 sm:flex-row'>
                <Button
                  ...
                  disabled={!canUpdateMeal() || isEstimating}
                  size='lg'
                  className='flex-1'
                >
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete this meal from
                        your log.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
